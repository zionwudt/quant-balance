  ...
  return {
    ...
    tooltip: {
      ...
      formatter(params) {
        ...
        overlays.forEach(item => {
          html += `<div style="color:${item.color || '#94a3b8'}">${item.seriesName}: ${formatNum(item.data)}</div>`;
        });
    ...
    yAxis: [
      ...
      },
      {
        ...
        splitNumber: 2,
        axisLine: { show: false },
        axisLabel: { color: '#8888a0', fontSize: 11, formatter: formatVolume },
      ...
      },
      {
        ...
        itemStyle: {
          color(params) {
            ...
            return toNumber(bar.close) >= toNumber(bar.open) ? 'rgba(34, 197, 94, 0.7)' : 'rgba(239, 68, 68, 0.72)';
          },
        },
      },
    ],
